...
/* A small set of inline stroke icons, drawn on a 24×24 grid. Inline (not an icon
   font or package) so they inherit currentColor, theme cleanly, and add no deps.
   Used by the sidebar nav, section empty states, and the top bar. */
...
export function LibraryIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...base} {...props}>
      ...
      <path d="M16.5 4.5l3.5 1-3 15-3.5-1" />
    </svg>
  );
}
